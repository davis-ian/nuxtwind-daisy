<template>
  <div>
    ...
    <generic-panel>
      <div class="flex flex-col">
        ...
        <p class="md:text-lg">
          ...
          is already included in this starter template project. From custom
          font, icons, animations, and more.
        </p>
      </div>
    </generic-panel>
    ...
    <generic-panel>
      <div class="flex flex-col mb-5">
        <h1 class="text-xl md:text-3xl mb-5">
          Icons by Line Awesome <i class="las la-icons text-primary"></i>
        </h1>
        <p class="md:text-lg">
    ...
    <generic-panel>
      <div class="flex flex-col mb-5">
        <h1 class="text-xl md:text-3xl mb-5">
          Animation by AOS.js <i class="las la-running text-primary"></i>
        </h1>
        <p class="md:text-lg">
          Check
          <a
